...
- **Robust project context** in `CLAUDE.md` / `AGENTS.md` / `docs/specs/**`. Plans and task cards do NOT carry project-specific guardrails; every subagent loads the repo's own context.
